...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/Prova Project/Coap Server/hvac_device.c</source>
    ...
    <motetype>
      ...
      <description>temp hum sensor</description>
      <source>[CONTIKI_DIR]/Prova Project/Coap Server/temperature_humidity_device.c</source>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>24.01091572487244</x>
        <y>61.002450051394476</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>44.68353525326477</x>
        <y>12.306673871156049</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.09938521062029</x>
        <y>49.97221869176162</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>66.80226633910132</x>
        <y>56.02645829878572</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>88.44754798815677</x>
        <y>4.9534635029658265</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.600722983273639 0.0 0.0 4.600722983273639 -36.55903047967458 21.27755631382262</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
